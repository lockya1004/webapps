...
SET DEFINE OFF;
Insert into PROJECT.REQUEST (NUM,PASS,USERID,TITLE,SOURCELANG,TARGETLANG,CONTENT,REFILE,DEADLINE,CASH,READCOUNT,WRITEDATE,NOW) values (5,'1234','admin','테스트','82','81','의뢰합니다',null,to_date('18/03/22','RR/MM/DD'),10000,20,to_date('18/03/22','RR/MM/DD'),'0');
