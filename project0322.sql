...
SET DEFINE OFF;
Insert into PROJECT.REQUEST (NUM,PASS,USERID,TITLE,SOURCELANG,TARGETLANG,CONTENT,REFILE,DEADLINE,CASH,READCOUNT,WRITEDATE,NOW) values (5,'1234','admin','테스트','korean','english','의뢰합니다',null,to_date('18/03/22','RR/MM/DD'),10000,19,to_date('18/03/22','RR/MM/DD'),'0');
...
Insert into PROJECT.REQUEST (NUM,PASS,USERID,TITLE,SOURCELANG,TARGETLANG,CONTENT,REFILE,DEADLINE,CASH,READCOUNT,WRITEDATE,NOW) values (7,'1234','admin','55555','4','11','123456',null,to_date('17/12/03','RR/MM/DD'),1000,0,to_date('18/03/22','RR/MM/DD'),'0');
...
SET DEFINE OFF;
Insert into PROJECT.WEATHER (LOCATION,TEMP,ICON) values ('Daegu',3,'10d');
Insert into PROJECT.WEATHER (LOCATION,TEMP,ICON) values ('Incheon',3,'10d');
Insert into PROJECT.WEATHER (LOCATION,TEMP,ICON) values ('Gwangju',3,'10d');
Insert into PROJECT.WEATHER (LOCATION,TEMP,ICON) values ('Daejeon',3,'50d');
Insert into PROJECT.WEATHER (LOCATION,TEMP,ICON) values ('Ulsan',4,'10d');
Insert into PROJECT.WEATHER (LOCATION,TEMP,ICON) values ('Jeju',6,'10d');
Insert into PROJECT.WEATHER (LOCATION,TEMP,ICON) values ('Seoul',3,'13d');
Insert into PROJECT.WEATHER (LOCATION,TEMP,ICON) values ('Busan',4,'10d');
--------------------------------------------------------
